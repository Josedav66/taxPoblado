...
<div class="container-img-principal">
    ...
    <div class="row-img-principal">
       ...
       <img src="{{asset('img/1398 TAX POBLADO luneta taxi-01.png')}}"   alt="imagen" >
...
<div class="row-frase">
   <div class="frase">
      <h2>Una manera de servir !</h2>
   </div>
   <div class="text-frase">
      <p>Conoce un poco más de nosotros.</p>
      <a href="{{url('/sobreNosotros/empresa')}}">Leer más</a>
   </div>
</div>
</div>
...
<div class="container-informacion" style="position: relative">
<div class="info">
   <p>
      Su opinión es lo más importante, por eso te invitamos a dejar una sugerencia,
       queja o felicitación por parte de los asesores o sobre la paginá web ingresando
        con el botón de abajo.
   </p>
   <a href="{{url('/contactanos/sugerencias')}}">Hacer Sugerencia</a>
</div>
<div class="imagen-info">
   <!--<img src="https://mercadatossa.com/wp-content/uploads/2020/10/wheel_menu.png" alt="">-->
</div>
...
<div class="contenedor-animacion">
   ...
   <div class="button-solicitar">
      <div id="container">
         <button class="learn-more button">
           <span class="circle" aria-hidden="true">
             <span class="icon arrow"></span>
           </span>
           <span class="button-text">Pedir taxi</span>
         </button>
       </div>
   </div>

   <div class="imagen-carretera">
      <img src="{{asset('img/carretera.png')}}" alt="">
   </div>

   <div class="row-animacion">
      <script src="https://unpkg.com/@lottiefiles/lottie-player@latest/dist/lottie-player.js"></script> <lottie-player src="https://lottie.host/c6da1af4-41ff-49c2-9e87-252d1461da5b/JzfkB9Afwx.json" background="transparent" speed="1" style="width: 300px; height: 300px;" loop autoplay></lottie-player>
   </div>
		...
		<div class="threeholder">
			<div class="threeone">
				...
				<div class="circleborder">
					...
					<h4>Acopios</h4>
					<p>Conoce un poco sobre donde estan los puntos de operación de taxPoblado.</p>
				</div>
...
<g>
					...
					<h4>App pasajero</h4>
					<p>Descarga la app Pasajero para pedir tu taxi en taxPoblado.</p>
				</div>
			...
			<div class="circlepic">
				...
				<div class="circleborder">
					...
					<h4>Tarifas</h4>
					<p>Conoce las tarifas del momento.</p>
				</div>
